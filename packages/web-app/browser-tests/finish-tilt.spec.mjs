...
// `mise run test`. Both cases run on the `?state=finish` board, with the tilt
// preference seeded either way.
...
// `earlyMs` lands inside the 0.18s tilt transition, which is where the twitch shows
// itself: a regression turns a boardful of cards this early. The whole sample runs
