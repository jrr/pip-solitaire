...
//
// Restart · Share above New Deal · Enter Seed: four buttons in two sections that
...
// Every game button, in the order the panel reads: the "this game" pair, then "new
...
test("lays the four game buttons out as one grid, each half the pane", async ({ page }) => {
  ...
  // Column for column: New Deal sits under Restart, Enter Seed under Share.
