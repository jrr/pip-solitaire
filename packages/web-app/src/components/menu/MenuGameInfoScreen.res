...
// the link out to the rules in full. `<GameInfo>` decides the numbers, the paragraph and
// the link, `BoardPreview` the still and `<MenuVariantPicker>` the boards; this file
// only places them.
//
