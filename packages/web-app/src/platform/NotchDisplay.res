...
// rules in styles/landscape-rail.css); this attribute lets a player fall back to a layout clamped
...
//     in styles/landscape-rail.css neutralise the wing negative-margins, so every control stays
